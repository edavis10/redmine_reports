...
RedminePluginSupport::Base.setup do |plugin|
  plugin.project_name = 'redmine_reports'
  plugin.default_task = [:spec, :features]
  plugin.tasks = [:doc, :release, :clean, :test, :spec, :features]
...
begin
  ...
  Jeweler::Tasks.new do |s|
    s.name = "redmine_reports"
    s.summary = "This is a plugin for Redmine reports"
    s.email = "edavis@littlestreamsoftware.com"
    s.homepage = "https://projects.littlestreamsoftware.com/projects/TODO"
    s.description = "This is a plugin for Redmine reports"
    s.authors = ["Eric Davis"]
    s.rubyforge_project = "redmine_reports" # TODO
    s.files =  FileList[
                        "[A-Z]*",
                        "init.rb",
                        "rails/init.rb",
